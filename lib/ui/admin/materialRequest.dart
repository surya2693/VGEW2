...
class _AdminMaterialRequestState extends State<AdminMaterialRequest> {
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                topCardUi("Material Request",
                    "Please look at the material request and take further actions"),
                const SizedBox(
                  height: 12,
                ),
                const Text(
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      flex: 1,
                      child: gridCard(
                          "SITE ENGINEER", "Bryson M", 'B', isChecked, (value) {
                        if (value != null) {
                          setState(() {
                            isChecked = value;
                            isChecked2 = false;
                    ...
                    Expanded(
                      flex: 1,
                      child: gridCard("MANAGER", "Newton D", 'N', isChecked2,
                          (value) {
                        if (value != null) {
                          setState(() {
                            isChecked2 = value;
                ...
                topCardUi(
                    "Requested Materials", "List of requested materials."),
                const SizedBox(
                  height: 10,
                ),
                Container(
                ...
                topCardUi("Cost Estimate",
                    "Approx. cost estimate from site engineer and defined data"),
                const SizedBox(
                  height: 10,
                ),
                ListView.builder(
  ...
  gridCard(String title, String subtitle, String circleTitle, bool isChecked,
      Function onClick) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
